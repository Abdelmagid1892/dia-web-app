const LemmaData = {
  "per quanto riguarda": {
    ...
    noteBibliografia: "Wierzbicka, A. (1986). What's in a Noun? (Or: How do nouns differ in meaning from adjectives?). Studies in Language."
  },
  "dal punto di vista": {
    lemma: "dal punto di vista",
    funzioni: [
      {
        macroFunzione: "ORGANIZZARE IL TESTO",
        ...
        sequenzeTestuali: ["Dal punto di vista teorico, il modello sembra solido. Tuttavia, dal punto di vista pratico, presenta alcune criticità."],
        particolaritaMorfosintattiche: "La locuzione è invariabile",
        suggerimentiUso: "Utile per analizzare un argomento da diverse angolazioni o per specificare il contesto di un'affermazione"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sulla locuzione 'dal punto di vista'"
  },
  "osservare": {
    lemma: "osservare",
    funzioni: [
      {
        ...
        sequenzeTestuali: ["Osservando attentamente i dati, si può notare una tendenza crescente negli ultimi anni."],
        particolaritaMorfosintattiche: "Può essere usato in varie forme verbali, incluso il gerundio",
        suggerimentiUso: "Utile per introdurre un'analisi o un commento critico"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sul verbo 'osservare'"
  },
  "in relazione a": {
    lemma: "in relazione a",
    funzioni: [
      {
        macroFunzione: "ORGANIZZARE IL TESTO",
        ...
        sequenzeTestuali: ["In relazione alla proposta presentata, il comitato ha espresso alcune riserve. In particolare..."],
        particolaritaMorfosintattiche: "La locuzione è invariabile",
        suggerimentiUso: "Utile per collegare diverse parti del discorso o per riferirsi a elementi precedentemente menzionati"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sulla locuzione 'in relazione a'"
  },
  "per quanto concerne": {
    lemma: "per quanto concerne",
    funzioni: [
      {
        macroFunzione: "ORGANIZZARE IL TESTO",
        funzione: "INDICARE DISCONTINUITÀ TEMATICA",
        ...
        sequenzeTestuali: ["L'azienda ha registrato ottimi risultati nel settore vendite. Per quanto concerne la produzione, invece, ci sono stati alcuni rallentamenti dovuti..."],
        particolaritaMorfosintattiche: "Il verbo 'concerne' è sempre alla terza persona singolare del presente indicativo",
        suggerimentiUso: "Utile per introdurre un nuovo argomento o aspetto in un discorso formale o accademico"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sulla locuzione 'per quanto concerne'"
  },
  "in materia": {
    lemma: "in materia",
    funzioni: [
      {
        ...
        sequenzeTestuali: ["In materia di diritto del lavoro, la giurisprudenza ha subito notevoli cambiamenti negli ultimi anni. In particolare..."],
        particolaritaMorfosintattiche: "La locuzione è invariabile",
        suggerimentiUso: "Particolarmente utile in contesti legali, amministrativi o accademici per specificare l'area di pertinenza di un argomento"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sulla locuzione 'in materia'"
  },
  "in merito a": {
    lemma: "in merito a",
    funzioni: [
      {
        ...
        sequenzeTestuali: ["Il comitato si è riunito per discutere varie questioni. In merito al primo punto all'ordine del giorno, è stato deciso che..."],
        particolaritaMorfosintattiche: "La locuzione è invariabile",
        suggerimentiUso: "Utile in contesti formali per introdurre un argomento specifico o per rispondere a una questione precedentemente sollevata"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sulla locuzione 'in merito a'"
  },
  "relativamente a": {
    lemma: "relativamente a",
    funzioni: [
      {
        macroFunzione: "ORGANIZZARE IL TESTO",
        funzione: "INDICARE RIFERIMENTO",
        ...
        sequenzeTestuali: ["L'azienda ha mostrato progressi in diversi settori. Relativamente alle vendite, si è registrato un aumento del 15% rispetto all'anno precedente."],
        particolaritaMorfosintattiche: "La locuzione è invariabile",
        suggerimentiUso: "Utile per introdurre un argomento specifico in un contesto più ampio o per fare riferimento a un aspetto particolare di una discussione"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sulla locuzione 'relativamente a'"
  },
  "notare": {
    lemma: "notare",
    funzioni: [
      {
        ...
        sequenzeTestuali: ["I dati mostrano un trend positivo negli ultimi mesi. È da notare, tuttavia, che ci sono state alcune fluttuazioni significative."],
        particolaritaMorfosintattiche: "Può essere usato in varie forme verbali, incluso l'imperativo",
        suggerimentiUso: "Utile per enfatizzare un punto importante o per guidare l'attenzione del lettore/ascoltatore verso un aspetto specifico"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sul verbo 'notare'"
  },
  "notare che": {
    lemma: "notare che",
    funzioni: [
      {
        ...
        sequenzeTestuali: ["L'esperimento ha prodotto risultati interessanti. Notare che, in alcuni casi, la reazione è stata più rapida del previsto."],
        particolaritaMorfosintattiche: "Spesso usato all'infinito o all'imperativo, ma può anche essere coniugato in altre forme",
        suggerimentiUso: "Particolarmente efficace per evidenziare un punto cruciale o per introdurre un'informazione che il lettore/ascoltatore dovrebbe tenere a mente"
      }
    ],
    noteBibliografia: "Riferimenti bibliografici sull'espressione 'notare che'"
  }
};
